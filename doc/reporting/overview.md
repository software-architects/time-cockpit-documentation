...
No, this is currently not supported. The time cockpit list engine is very powerful. You can even create lists based on [time cockpit scripts](~/doc/scripting/overview.md). In such a script you can put together data from all areas in time cockpit. However, this is quite an advanced scenario. If you want to build such a report and you have questions about it, please contact us at [support@timecockpit.com](mailto:support@timecockpit.com).
