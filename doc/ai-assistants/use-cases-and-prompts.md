...
description: Ready-to-use prompts for project managers, project controllers, HR administrators, time tracking users, and department leads working with time cockpit through an AI assistant.
---
