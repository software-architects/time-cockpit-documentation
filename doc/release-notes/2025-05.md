...
description: time cockpit release notes for May 2025. New features, improvements, and bug fixes for the time tracking platform.
---
# 📅 May 2025
...
- **Passive Booking Completion**  
  Added support for automatically locking timesheet entries based on the current date, helping to enforce booking deadlines more effectively. 👉 [Read more](~/doc/employee-time-tracking/passive-booking-completion.md)

- **Default Permissions**
  Introduced predefined default roles to give organizations more granular control over user permissions in Time Cockpit. 👉 [Learn more](~/doc/employee-time-tracking/default-permissions.md) and also take a look at our [Migration Guide](~/doc/migration-guides/default-permissions.md).
...
- **Working Time Limits for Weekly Hours**  
  ...
  👉 [Learn more](~/doc/employee-time-tracking/working-time-regulations.md)
