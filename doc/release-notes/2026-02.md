...
description: "time cockpit release notes for February 2026: improved absence management workflows, timesheet sharing as suggestions and expanded standard roles."
---
# 📅 February 2026
...
👉 [Read more](~/doc/employee-time-tracking/absence-time-management.md)
...
👉 [Read more](~/doc/timesheet-calendar/timesheet-suggestions-share-timesheet.md)
...
👉 [Standard permissions overview](~/doc/employee-time-tracking/default-permissions.md)
👉 [Migration guide](~/doc/migration-guides/default-permissions.md)
...
### How to enable absence approvals (quick checklist)
  ...
  👉 [Absence approval workflow details](~/doc/employee-time-tracking/absence-time-management.md)
...
### How to enable Timesheet Suggestions (quick checklist)
  ...
  👉 [Timesheet suggestions / Share timesheet](~/doc/timesheet-calendar/timesheet-suggestions-share-timesheet.md)
