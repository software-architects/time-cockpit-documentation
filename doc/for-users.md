...
> [!TIP]
> **New to time cockpit?** Learn about the key features and benefits on our [main website](https://www.timecockpit.com/). This documentation provides detailed how-to guides for using the software.
...
- **[Time Tracking Calendar](https://www.timecockpit.com/features/time-tracking-calendar/)** - Intuitive graphical interface
- **[Activity Tracking](https://www.timecockpit.com/features/activity-tracking/)** - Automatic time capture (Windows)
- **[Reporting & Analytics](https://www.timecockpit.com/features/reporting/)** - Insights for better decisions
- **[Customization](https://www.timecockpit.com/features/customization/)** - Tailor time cockpit to your needs
- **[Integration](https://www.timecockpit.com/features/integration/)** - Connect with your existing tools
...
### Daily Time Tracking
Learn how to track your working hours efficiently with time cockpit's intuitive [graphical time tracking calendar](https://www.timecockpit.com/features/time-tracking-calendar/).
...
→ [Explore Employee Time Tracking Features](https://www.timecockpit.com/features/employee-time-tracking/)

### Reporting
Generate reports to analyze your time tracking data. Discover [powerful reporting capabilities](https://www.timecockpit.com/features/reporting/) for project controlling and business insights.
...
→ [Invoicing Guide](~/doc/project-time-tracking/billing.md) | [Learn about Project Invoicing Features](https://www.timecockpit.com/features/project-invoicing/)

**Export my timesheet data?**
→ [Data Export](~/doc/data-exchange/export.md)

**Import data from Excel?**
→ [Data Import](~/doc/data-exchange/import.md) | [Migrating from Excel?](https://www.timecockpit.com/blog/project-time-tracking-excel-migration-guide/)
...
→ [Project Time Tracking Documentation](~/doc/project-time-tracking/customer-project-task.md) | [Track Key Project KPIs](https://www.timecockpit.com/blog/project-timetracking-kpis/)
...
→ [Invoicing Documentation](~/doc/project-time-tracking/billing.md) | [Optimize Project Revenue](https://www.timecockpit.com/blog/project-time-tracking-revenue/)
...
For Windows users, the full client provides additional features like [automatic activity tracking](https://www.timecockpit.com/features/activity-tracking/):
...
For organizations using Azure Active Directory and requiring advanced security features:
- [AAD Integration](~/doc/enterprise/aad.md)

→ [Enterprise Edition Overview](https://www.timecockpit.com/features/enterprise/) | [Security Features](https://www.timecockpit.com/features/security/)
