---
title: Funktionen im Überblick - Leistungsumfang von time cockpit
description: "Funktionen von time cockpit nach Bereichen: Zeiterfassung, Projekte, Rechnungslegung, Mitarbeiterverwaltung, Berichte und Integrationen."
keywords: [time cockpit funktionen, funktionsübersicht, leistungsumfang, zeiterfassung funktionen, projektmanagement, rechnungslegung, arbeitszeiterfassung, berichte funktionen, funktionsleitfaden]
en_page: doc/features-overview.md
---
...
- **[Web-Client](~/doc/erste-schritte/web-client.md)** - Zugriff im Browser mit PWA-Unterstützung
- **[Mobiler Zugriff](~/doc/erste-schritte/mobile-zeiterfassung.md)** - 📱 **NEU!** time cockpit auf Smartphones und Tablets verwenden
- **[Installation des Vollclients](~/doc/erste-schritte/installationsanleitung.md)** - Desktop-Anwendung für Windows
...
- Rentabilität in Echtzeit verfolgen (Umsatz vs. Kosten)
- Den Projektabschluss prognostizieren und Überschreitungen erkennen
...
- Rentabilität durch Margenanalyse sicherstellen
...
- **[Genehmigungsworkflows](/doc/employee-time-tracking/approval-workflows.html)** - ✅ **NEU!** Vollständiger Leitfaden zu den Workflows
  ...
  - Genehmigungsworkflows für Zeitbuchungen (individuell)

**Wichtige Funktionen:**
- Genehmigungspflicht pro Abwesenheitsart aktivieren
- Abteilungsleiter genehmigen für ihre Teams
- HR-Administratoren übernehmen abteilungsübergreifende Genehmigungen
- Abwesenheitskalender mit offenen Genehmigungen
- Benachrichtigungssystem für Anträge und Entscheidungen
...
- Verrechenbare vs. nicht verrechenbare Zeit
...
### Erste Schritte
Neu bei time cockpit? Beginnen Sie hier.

- **[Überblick](~/doc/erste-schritte/ueberblick.md)** - Einführung in time cockpit
- **[Kontoverwaltung](~/doc/kontoverwaltung/kontoverwaltung.md)** - Benutzer- und Abrechnungsverwaltung

### Häufig gestellte Fragen
Kurze Antworten, geordnet nach Rolle.

**Allgemein:**
- **[Anwender-FAQ](~/doc/anwender-faq.md)** - Häufige Fragen aller Anwender
...
**Top 5 nach Nutzung:**
1. Zeiterfassungskalender - Tägliche Zeiterfassung
2. Projektbezogene Zeiterfassung - Arbeit an Kundenprojekten
3. Rechnungslegung - Kunden verrechnen
4. Abwesenheitsverwaltung - Urlaub und Krankenstand
5. Berichte - Zeit- und Budgetberichte
...
*Sie suchen etwas, das hier nicht aufgeführt ist? Verwenden Sie die Suche oder schreiben Sie an [support@timecockpit.com](mailto:support@timecockpit.com).*
