---
title: Urlaub zum Stichtag (Vacation per Effective Date)
description: Referenz der Standardliste Vacation per Effective Date in time cockpit mit Berechnung des Resturlaubs und Drill-down-Links.
en_page: doc/reference/lists/vacation-per-effective-date.md
---

# Urlaub zum Stichtag

Die Liste **Vacation per Effective Date** zeigt den Resturlaub jedes Benutzers zu einem ausgewählten Datum.
...
- Standardnavigation: `Benutzer -> Vacation per Effective Date`
...
|---|---|---|
| Effective Date | `@EffectiveDate` | Datum, für das der Resturlaub berechnet wird |
| Prorate | `@Prorate` | Bei Yes wird der Saldo um den noch nicht erworbenen Anteil aktueller Ansprüche verringert (siehe [Aliquoter Urlaub](~/doc/arbeitszeiterfassung/aliquoter-urlaub.md)) |
...
| Remaining Leave in Weeks | `RemainingWeeks` | Resturlaub zum ausgewählten Datum | Mit der Standardfunktion für den Resturlaub berechnet |
