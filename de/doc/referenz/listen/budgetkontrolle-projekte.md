...
- Standardnavigation: `Verwaltung -> Verrechnung -> Budgetkontrolle für Projekte`
...
| Verrechenbar | `BillableText`, `Billable` | Ob das Projekt verrechenbar ist | Aus dem Kennzeichen für Verrechenbarkeit des Projekts übernommen und als Text verrechenbar oder nicht verrechenbar angezeigt |
...
| Umsatz | `Revenue` | Durch die enthaltenen Zeitbuchungen erzielter Umsatz | Summe der Umsatzwerte der Zeitbuchungen |
