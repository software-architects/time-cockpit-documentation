...
Nein, das wird derzeit nicht unterstützt. Die Listen-Engine von time cockpit ist sehr leistungsfähig. Sie können sogar Listen auf Basis von [time cockpit-Skripten](~/doc/scripting/ueberblick.md) erstellen. In einem solchen Skript können Sie Daten aus allen Bereichen von time cockpit zusammenführen. Das ist allerdings ein recht fortgeschrittenes Szenario. Wenn Sie einen solchen Bericht erstellen möchten und Fragen dazu haben, wenden Sie sich bitte an [support@timecockpit.com](mailto:support@timecockpit.com).
