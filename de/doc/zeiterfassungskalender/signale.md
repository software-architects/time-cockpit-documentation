...
> [!NOTE]
> Standardmäßig werden Zeiträume der Inaktivität, die länger als 15 Minuten dauern, als Pausen interpretiert (hellgrün). Den Schwellenwert in Minuten können Sie jedoch im Optionsdialog ändern. Weitere Informationen finden Sie unter [Optionen des Signal Trackers](/doc/signal-tracker/options.html).
