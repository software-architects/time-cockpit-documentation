...
> [!NOTE]
> Der MCP-Server von time cockpit befindet sich derzeit in der Public Preview. Details finden Sie unter [MCP-Server](~/doc/mcp/ueberblick.md).
...
|-----------|--------|------------|
| Claude Code (Terminal) | getestet | [Claude Code](~/doc/mcp/claude-code.md) |
| Claude App, claude.ai, Cowork | getestet | [Claude App](~/doc/mcp/claude-app.md) |
| OpenAI Codex (CLI, Desktop-App, IDE) | getestet | [Codex](~/doc/mcp/codex.md) |
| ChatGPT (Web, Business-/Enterprise-Workspace) | getestet, wird von Ihrem Administrator eingerichtet | [ChatGPT](~/doc/mcp/chatgpt.md) |
| Visual Studio Code mit GitHub Copilot | getestet | [VS Code](~/doc/mcp/vscode.md) |
| GitHub Copilot CLI | derzeit nicht unterstützt | [Copilot CLI](~/doc/mcp/copilot-cli.md) |
| Microsoft 365 Copilot | erfordert Ihren Administrator | [Microsoft 365 Copilot](~/doc/mcp/microsoft-365-copilot.md) |

## Was Sie brauchen

- Ein Microsoft-Entra-ID-Geschäftskonto mit Zugriff auf time cockpit.
- Die Client-ID der App-Registrierung, die Ihr IT-Administrator für den MCP-Server in der Entra ID Ihrer Organisation angelegt hat. Siehe [Einrichtung in Entra ID](~/doc/mcp/entra-id-einrichtung.md).
...
Wie diese Einstellungen übergeben werden, hängt vom Assistenten ab – siehe [Verbindungseinstellungen](~/doc/mcp/ueberblick.md#verbindungseinstellungen-header-oder-url-segment). Schreibende Aktionen erfordern zusätzlich eine ausdrückliche Bestätigung im Gespräch.
...
- [MCP-Server (für Entwickler und Administratoren)](~/doc/mcp/ueberblick.md)
