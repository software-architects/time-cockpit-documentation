---
title: Für time cockpit Anwender
description: Einstiegsseite in die Anwenderdokumentation zu Zeiterfassung, Projektarbeit, Abwesenheiten, Rechnungslegung und Berichten in time cockpit.
en_page: doc/for-users.md
---

# Für time cockpit Anwender

Diese Seite hilft Ihnen, die wichtigsten Anwenderseiten der time cockpit Dokumentation zu finden.

## Erste Schritte

Nutzen Sie diese Seiten, wenn Sie neu bei time cockpit sind oder die wichtigsten Einstiegspunkte suchen:

- [Überblick](~/doc/erste-schritte/ueberblick.md)
- [Web-Client](/doc/getting-started/web-client.html)
- [Mobiler Zugriff](/doc/getting-started/mobile-guide.html)
...
- [Stundensätze verwalten](/doc/project-time-tracking/hourly-rates.html)

## Anwesenheit und Abwesenheit

Nutzen Sie diese Seiten für Abwesenheiten, Arbeitszeit und Genehmigungen:
...
- [Berichte: Überblick](/doc/reporting/overview.html)
- [Integrierte Berichte](/doc/reporting/built-in-reports.html)
- [Standard-Druckansicht](/doc/reporting/standard-print-view.html)
- [Datenimport](/doc/data-exchange/import.html)
...
- Funktionen des Windows-Desktop-Clients: [Signal Tracker: Überblick](/doc/signal-tracker/overview.html)
- Enterprise-Themen: [AAD-Integration](/doc/enterprise/aad.html)
- Versionshinweise: [Release Notes](/doc/release-notes/2026-02.html)

## Suchen Sie die Entwicklerdokumentation?

Wenn Sie time cockpit anpassen, Integrationen bauen oder Abläufe automatisieren möchten, lesen Sie weiter unter [Für Entwickler](/doc/for-developers.html).
