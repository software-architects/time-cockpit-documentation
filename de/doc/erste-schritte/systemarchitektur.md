...
Sie können das [Datenmodell](~/doc/datenmodell-anpassung/entitaet.md) von time cockpit erweitern. Es gibt verschiedene Arten von Eigenschaften, die Sie hinzufügen können. Die meisten davon werden in der Datenbank gespeichert. Wenn Sie Daten als BLOB speichern möchten, können Sie die [TimeCockpit.Data.DataModel.BinaryProperty](/api/TimeCockpit.Data.DataModel.BinaryProperty.html) verwenden (siehe auch [How To: Eine FileProperty hinzufügen](~/doc/scripting/dateieigenschaft-hinzufuegen.md)).
