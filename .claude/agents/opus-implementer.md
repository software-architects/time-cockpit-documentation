...
- After changing pages or the TOC, run `.\build.ps1 -SkipMetadata` (never a bare `docfx`; the script restores the pinned tool, builds and runs the post-build steps).
